...
function BackgroundEffect() {
  return (
    ...
    >
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full blur-[100px] transition-colors duration-500" style={{ backgroundColor: 'var(--orb1-color)' }} />
      <div className="absolute top-[20%] right-[-10%] w-[400px] h-[400px] rounded-full blur-[90px] transition-colors duration-500" style={{ backgroundColor: 'var(--orb2-color)' }} />
      <div className="absolute bottom-[-10%] left-[20%] w-[600px] h-[600px] rounded-full blur-[110px] transition-colors duration-500" style={{ backgroundColor: 'var(--orb3-color)' }} />
    </div>
  )
}
