    ...
    <div>
      <PageHeader title="Bot 管理">
        <div className="flex items-center gap-2">
          ...
          />
          <Button size="sm" variant="primary" onPress={handleAdd}>
            添加
          </Button>
        </div>
      </PageHeader>
                    ...
                    <Table.Cell>
                      <div className="flex items-center gap-1.5 flex-wrap">
                        <Button
                          size="sm"
                          variant="outline"
                          onPress={() => handleShowConfig(bot.name)}
                        >
                          配置
                        </Button>
                        {bot.connected ? (
                          <Button
                            size="sm"
                            variant="danger-soft"
                            onPress={() => handleToggle(bot.name, false)}
                          >
                            断开
                          </Button>
                        ) : (
                          <Button
                            ...
                            onPress={() => handleToggle(bot.name, true)}
                          >
                            连接
                          </Button>
                        )}
                        <Button
                          size="sm"
                          variant="danger-soft"
                          onPress={() => setDeleteTarget(bot.name)}
                        >
                          删除
                        </Button>
                      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <RadioGroup
              ...
              onChange={(value) =>
                configData &&
                setConfigData({ ...configData, mode: value as "ws" | "http" })
              }
            >
              <Radio value="ws">
                <Radio.Control>
                ...
                <Radio.Content>WebSocket</Radio.Content>
              </Radio>
              <Radio value="http">
                <Radio.Control>
                  <Radio.Indicator />
                </Radio.Control>
                <Radio.Content>HTTP</Radio.Content>
              </Radio>
            </RadioGroup>
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                configData &&
                setConfigData({ ...configData, wsUrl: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                configData &&
                setConfigData({ ...configData, httpUrl: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                configData &&
                setConfigData({ ...configData, wsToken: e.target.value })
              }
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                configData &&
                setConfigData({ ...configData, httpToken: e.target.value })
              }
            />
          </div>
        </div>
