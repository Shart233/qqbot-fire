...
export default function NapCatPage() {
  ...
  const [config, setConfig] = useState<NapCatConfig>({
    napCatDir: "",
    workRoot: "",
  });
  ...
  const handleDiscover = async () => {
    ...
    if (data !== null) {
      toast.success(
        `发现完成: 新建 ${data.created || 0} 个，共 ${data.total || 0} 个 Bot`,
      );
  ...
  return (
    <div>
      <PageHeader title="NapCat 管理">
        <Button size="sm" variant="outline" onPress={handleDiscover}>
          自动发现
        </Button>
      </PageHeader>
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <Button size="sm" variant="primary" onPress={handleSaveConfig}>
            保存配置
          </Button>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            {runningInstances.length > 0 && (
              <Button size="sm" variant="danger-soft" onPress={handleStopAll}>
                停止全部
              </Button>
            )}
          </div>
                      ...
                      <Table.Cell>
                        <div className="flex items-center gap-1.5">
                          <Button
                            size="sm"
                            variant="primary"
                            onPress={() => handleStartSaved(i.name)}
                          >
                            启动
                          </Button>
                          <Button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
            ...
            <div>
              <label className="text-sm text-text-muted mb-1 block">
                QQ 号{" "}
                {matchedSaved && (
                  <span className="text-accent">(自动填充)</span>
                )}
              </label>
              <QQHistoryInput
                storageKey="ncQQ"
      ...
      <SimpleModal
        ...
        footer={
          <>
            <Button size="sm" variant="ghost" onPress={() => setEditName(null)}>
              取消
            </Button>
            <Button
              size="sm"
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                editData && setEditData({ ...editData, qqUin: e.target.value })
              }
            />
          </div>
          <div>
